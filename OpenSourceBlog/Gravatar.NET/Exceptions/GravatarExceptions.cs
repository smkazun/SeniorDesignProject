...
{	
	...
	{
		public GravatarEmailHashFailedException(string address, Exception ex): base(String.Format("Address: '{0}' failed to be hashed", address), ex)
		{
		}
	...
	{
		public GravatarRequestException(Exception exception): base("Failed to make request to Gravatar server", exception)
		{
		}
	}
